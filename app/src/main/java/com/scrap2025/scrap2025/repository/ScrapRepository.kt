...
interface ScrapRepository {
    ...
    /** 특정 ID의 스크랩 아이템 조회 */
    fun getScrapItemByIdAsFlow(id: String): Flow<Result<ScrapItem>>
    ...
    suspend fun toggleFavoriteBulk(scrapIdBulk: List<String>): Result<Unit>
    ...
    suspend fun syncScrapsByCategoryId(categoryId: String, categoryRemoteId: Int): Result<Unit>
